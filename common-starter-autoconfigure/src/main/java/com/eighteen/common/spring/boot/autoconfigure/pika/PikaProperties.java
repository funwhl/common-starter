...
import static com.eighteen.common.spring.boot.autoconfigure.pika.PikaProperties.PREFIX;


/**
 * pika 配置 (same as RedisProperties)
 * @author lcomplete
 */
@ConfigurationProperties(prefix = PREFIX)
@Data
public class PikaProperties {
    public static final String PREFIX = "ybdx.pika";
