package com.eighteen.common.spring.boot.autoconfigure.mybatis.feedback;
...
public class FeedbackAutoConfiguration {
    ...
    FeedbackService feedbackService() {
        return new FeedbackService() {
            ...
            @Override
            public void clean(FeedbackServiceImpl.JobType type) {

            }

            @Override
            public void stat(FeedbackServiceImpl.JobType type) {
