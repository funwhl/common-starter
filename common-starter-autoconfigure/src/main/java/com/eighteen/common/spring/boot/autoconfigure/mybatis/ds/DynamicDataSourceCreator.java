 ...
 * <pre/>
 */
package com.eighteen.common.spring.boot.autoconfigure.mybatis.ds;
...
import com.eighteen.common.spring.boot.autoconfigure.ds.autoconfigure.druid.DruidWallConfigUtil;
...
public class DynamicDataSourceCreator {
    ...
    public DataSource createBasicDataSource(DataSourceProperty dataSourceProperty) {
        try {
            ...
            throw new RuntimeException("dynamic-datasource create basic database named " + dataSourceProperty.getPollName()
                    + " error");
        }
    }
