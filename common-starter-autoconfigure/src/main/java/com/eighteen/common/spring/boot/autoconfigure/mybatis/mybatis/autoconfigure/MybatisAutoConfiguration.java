 ...
 */
package com.eighteen.common.spring.boot.autoconfigure.mybatis.mybatis.autoconfigure;

import com.eighteen.common.spring.boot.autoconfigure.mybatis.interceptor.PageInterceptor;
...
public class MybatisAutoConfiguration implements InitializingBean {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        Interceptor page = new PageInterceptor();
        List<Interceptor> list = new ArrayList<>();
        list.add(page);
        if (interceptors != null) list.addAll(Arrays.asList(interceptors));
