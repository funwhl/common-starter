...
public class DataSourcePicker {
    ...
    public static String getDataSourceByActiveType(String activeType) {
        if (Lists.newArrayList(DsConstants.WEIXIN, DsConstants.SIGMOB, DsConstants.KUAISHOU, DsConstants.BAIDU, DsConstants.TOUTIAO, DsConstants.GDT,DsConstants.STORE).contains(activeType)) {
            return activeType;
        }
        return null;
    }
